    ...
    return (
        <section id="home">
            <div className="flex flex-col-reverse md:flex-row px-10 sm:px-8  md:px-20 lg:px-40 sm:py-12 sm:gap-x-8 md:py-16 text-center md:text-left animate__fadeInDown">
                ...
                <img src={ownerImage} alt="" className=" object-contain rounded-full m-auto w-full md:w-3/6 animate__fadeInRight mt-10 mb-5 md:mt-auto md:mb-auto" width="350px" height="400px" />
            </div>
