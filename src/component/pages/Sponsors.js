...
export default function Sponsors() {
    return (
        <section id="sponsors">
            ...
            <h2 className="text-2xl text-black font-semibold  sm:text-3xl sm:leading-7 mb-4 md:text-4xl sm:w-80 md: text-center m-auto text-wrap">Get Started With Paddle Today</h2>
