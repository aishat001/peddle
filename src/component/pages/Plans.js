                        ...
                        plans.map((p, i) => {
                            ...
                            >
                                ...
                                <div className="mb-5 w-3/10 text-center h-40 sm:h-60 flex flex-col">
                                        <h5 className="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white mx-auto" key={i}>{p.title}</h5>
                                    ...
                                    <p className="font-normal text-bold text-3xl text-center p-0 dark:text-gray mt-2 sm:mt-8 mb-5" key={i}>{p.price}</p>
